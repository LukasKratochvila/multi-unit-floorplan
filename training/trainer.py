...
class Trainer:
    ...
    :param checkpoint_weights_only: Flag if save whole model or weights only
    ...
    def __init__(self,
        ...
        self.checkpoint_weights_only = checkpoint_weights_only
    ...
    def _build_callbacks(self,
        ...
        if isinstance(self.checkpoint_callback, Callback):
            ...
            if self.checkpoint_weights_only:
                callbacks.append(ModelCheckpoint(self.log_dir_path + "/weights",

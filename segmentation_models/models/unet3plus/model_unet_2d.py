...
from segmentation_models.base.layer_utils import CONV_stack, CONV_output, decode_layer, encode_layer

from segmentation_models import backbone_zoo


def UNET_left(X, channel, kernel_size=3, stack_num=2, activation='ReLU',
              pool=True, batch_norm=False, name='left0', square_conv=True,
              enhance_skeleton=False, direction_aware=False):
    '''
    ...
    X = CONV_stack(X, channel, kernel_size, stack_num=stack_num, activation=activation,
                   ...
                   square_conv=square_conv, enhance_skeleton=enhance_skeleton, direction_aware=direction_aware)
...
def UNET_right(X, X_list, channel, kernel_size=3,
               ...
               square_conv=True, enhance_skeleton=False, direction_aware=False):
    '''
...
def unet_2d_base(input_tensor, filter_num, stack_num_down=2, stack_num_up=1,
...
def unet_2d(input_size, filter_num, n_labels, stack_num_down=2, stack_num_up=1,
            activation='ReLU', output_activation='Softmax', batch_norm=False, pool=True, unpool=True,
            backbone=None, weights='imagenet', freeze_backbone=True, freeze_batch_norm=True, name='unet', aaf=False):
    '''

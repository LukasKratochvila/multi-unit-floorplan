...
from segmentation_models.models.unet3plus.utils import freeze_model

layer_cadidates = {
    'seresnext50': (4, 254, 584, 1078),
...
def backbone_zoo(backbone_name, weights, input_tensor, depth, freeze_backbone, freeze_batch_norm, **kwargs):
    '''
    ...
    backbone_ = backbone_func(include_top=False, weights=weights, input_tensor=input_tensor, pooling=None) #, **kwargs)
